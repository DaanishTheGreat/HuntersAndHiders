...
public class MapCenter_CommonComponent
{
    public List<string> coordinates { get; set; }
}

public class Resource_CommonComponent
{
    public string __type { get; set; }
    public List<double> bbox { get; set; }
    public string imageHeight { get; set; }
    public string imageWidth { get; set; }
    public MapCenter_CommonComponent mapCenter { get; set; }
    public List<object> pushpins { get; set; }
    public string zoom { get; set; }
}

public class ResourceSet_CommonComponent
{
    public int estimatedTotal { get; set; }
    public List<Resource_CommonComponent> resources { get; set; }
}

public class Root_CommonComponent
{
    public string authenticationResultCode { get; set; }
    public string brandLogoUri { get; set; }
    public string copyright { get; set; }
    public List<ResourceSet_CommonComponent> resourceSets { get; set; }
...
public class PlayerSpriteUpdateLocation_CommonComponent : MonoBehaviour
{
    ...
    public IEnumerator UpdateLocationOnMap(double Latitude, double Longitude)
    {
        ...
        else
        {
            ...
            Root_CommonComponent JsonMetaDataObject = JsonConvert.DeserializeObject<Root_CommonComponent>(JsonString);
